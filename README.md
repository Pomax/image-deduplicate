...
You can find versioned downloads over on [the releases branch](./tree/releases), with the release log [here](https://github.com/Pomax/image-deduplicate/blob/releases/RELEASE_LOG.md).
